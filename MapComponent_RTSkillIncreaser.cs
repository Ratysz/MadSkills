                ...
                {       // NRE safety, because screw it; same check is done by Pawn_SkillTracker.SkillsTick()
                    ...
                    {       // Iterate over pawn's skills.
                        ...
                        {       // Similar thing happens in SkillRecord.Interval()
                            case 10:
                                skillRecord.Learn(0.5f * 0.125f / skillRecord.LearningFactor);     // SkillRecord.Interval() pre-multiplies positive gains.
                                break;
                            case 11:
                                skillRecord.Learn(0.5f * 0.25f / skillRecord.LearningFactor);
                                break;
                            case 12:
                                skillRecord.Learn(0.5f * 0.5f / skillRecord.LearningFactor);
                                break;
                            case 13:
                            ...
                            case 14:
                                ...
                                break;
                            case 15:
                                skillRecord.Learn(0.5f * 2.1f / skillRecord.LearningFactor);
                                break;
                            case 16:
                                skillRecord.Learn(0.5f * 3.5f / skillRecord.LearningFactor);
                                break;
                            case 17:
                                skillRecord.Learn(0.5f * 5f / skillRecord.LearningFactor);
                                break;
                            case 18:
                                skillRecord.Learn(0.5f * 7f / skillRecord.LearningFactor);
                                break;
                            case 19:
                                skillRecord.Learn(0.5f * 8f / skillRecord.LearningFactor);
                                break;
                            case 20:
                                skillRecord.Learn(0.5f * 12f / skillRecord.LearningFactor);
                                break;
                        }
                    }
                }
